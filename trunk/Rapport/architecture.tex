...
Chacune de ces phases sera représentée par une ou des méthodes contenue(s) dans une classe dédiée.\newline
...
l'ordinateur, corresponde à celle du moteur de
...
Il faudra soumettre aux règles des grilles correctes et vérifier que la 
grille n'est pas modifiée. Dans le cas où il y a un
