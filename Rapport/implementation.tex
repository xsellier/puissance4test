...
contrainte disant que \texttt{i} et \texttt{j} doivent être compris entre 0 et respectivement
...
\item Qu'une position donnée est jouable en remplissant la grille
  aléatoirement mais de manière à ce qu'une position soit jouable/non
  jouable.  \newline

Tester qu'un coup sur la ligne 0 de la grille n'est pas jouable
s'écrira :\newline
\begin{center}
