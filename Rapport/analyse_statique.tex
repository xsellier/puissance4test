...
couverture suffisant pour être pertinentes. Cela à grandement facilité
la mise en place d'un startégie de test efficace des différents
modules du puisssance4. Il est aussi intéressant de mentioner le fait
que la création du CFA \texttt{vérification\_choix()} nous a permit de
...
permit de corriger très tôt ce problème. 