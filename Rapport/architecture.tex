...
instancier la structure de données, les joueurs, les règle de jeu ainsi
...
particulières pour la grille. On vérifie que l'objet crée a la taille demandée.

\bigskip
\item Instanciation incorrecte\newline
Dans un soucis de robustesse, on traite le cas ou une
...
doit en tenir compte et construire une grille de taille minimale 6$\times$7.
\bigskip
...
doit pouvoir traiter les saisies incorrecte. Cela ne
ne veut pas dire qu'elle devra les interpréter, mais plutôt qu'elle
doit avertir l'utilisateur qu'il y a eu une mauvaise saisie à travers
...
De la même manière on doit vérifier que la grille fournit à
